...
function ContentTabs() {
  ...
  return (
    <div className="content-tabs-section pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-y-5 md:gap-x-5">
              ...
              <div className="bg-neutral-100 p-6 rounded-2xl">
                ...
                >
                  <li role="presentation" className="flex-grow">
                    <button
                      onClick={() => handleTabChange("tabs-01")}
                      className={`my-2 block border-b pb-3.5 pt-4 text-lg font-medium capitalize leading-tight ${
                        activeTab === "tabs-01" ? "text-blue-500" : ""
                      }`}
                      aria-controls="tabs-01"
                      aria-selected={activeTab === "tabs-01" ? "true" : "false"}
                      role="tab"
                    >
                  ...
                  <li role="presentation" className="flex-grow">
                    <button
                      onClick={() => handleTabChange("tabs-02")}
                      className={`my-2 block border-b pb-3.5 pt-4 text-lg font-medium capitalize leading-tight ${
                        activeTab === "tabs-02" ? "text-blue-500" : ""
                      }`}
                      aria-controls="tabs-02"
                      aria-selected={activeTab === "tabs-02" ? "true" : "false"}
                      role="tab"
                    >
                  ...
                  <li role="presentation" className="flex-grow">
                    <button
                      onClick={() => handleTabChange("tabs-03")}
                      className={`my-2 block border-b pb-3.5 pt-4 text-lg font-medium capitalize leading-tight ${
                        activeTab === "tabs-03" ? "text-blue-500" : ""
                      }`}
                      aria-controls="tabs-03"
                      aria-selected={activeTab === "tabs-03" ? "true" : "false"}
                      role="tab"
                    >
                      Another Topic
                    </button>
          ...
          <div className="my-2 col-span-2 order-2 md:order-1">
            ...
            >
              <div className="mb-10">
                ...
                <p className="tex-lg text-pretty">
                  ...
                  sources that helps factories achieve sustainability and reduce
                  operating costs. With the increasing demand for clean and
                  environmentally friendly energy sources, solar energy has
                  become an ideal choice for many industries. This article
                  reviews the most prominent advantages of using solar energy in
                  factories.
                </p>
              </div>
              <div className="mb-10">
                ...
                <p className="tex-lg text-pretty mb-5">
                  ...
                  friendly heat pumps. Its job is to hydraulically separate the
                  heat generator circuit from the heating circuit.
                </p>
                ...
                <ul className="list-disc list-inside text-lg space-y-5 mb-8">
                  <li className="flex items-start gap-x-2">
                    ...
                    <span className="flex-1">
                      In the optimal state, when the volume flows are balanced,
                      the heat reaches almost all of the heating circuit. This
                  ...
                  <li className="flex items-start gap-x-2">
                    ...
                    <span className="flex-1">
                      ...
                      or unnecessary flow is mixed. This reduces the performance
                      of the heat pump.
                    </span>
                  </li>
                  <li className="flex items-start gap-x-2">
                    <span className="shrink-0 text-2xl leading-tight">•</span>
                    <span className="flex-1">
                      A return flow increase caused by the mixing effect of the
                      switch can negatively influence the COP.
                    </span>
                  </li>
                </ul>
                <Image
            ...
            >
              ...
              <p className="tex-lg text-pretty">
                Content for tab 2 goes here. You can explain the function of the
                hydraulic switch or whatever the topic is for this tab.
              </p>
            </div>
